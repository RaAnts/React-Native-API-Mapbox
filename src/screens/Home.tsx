...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    Geolocation.getCurrentPosition(
      ...
      error => console.log('Error getting location home:', error),
    ...
    <View style={styles.container}>
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={handleNearbyPress} style={styles.button}>
          ...
          <Text style={styles.buttonTextNearby}>Proche</Text>
        </TouchableOpacity>
        <View style={styles.divider} />
        <TouchableOpacity onPress={handleAllPress} style={styles.button}>
          <Icon name="globe-outline" size={20} color="white" />
          <Text style={styles.buttonTextAll}>Toute</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.sliderContainer}>
        <Text style={styles.distanceText}>Distance : {selectedDistance} km</Text>
        <Slider
          style={styles.slider}
          minimumValue={1}
          maximumValue={3}
