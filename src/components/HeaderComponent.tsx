...
import Ionicons from 'react-native-vector-icons/Ionicons'; // Import a store icon from a library of icons (e.g., Material Icons)
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.middleContent}>
        <Text style={styles.title}>Mon Hopital à proximité</Text>
      </View>
